...
function get_job_list($page = 1, $jobs_per_page = 20) {
    global $conn;
    $offset = ($page - 1) * $jobs_per_page;
$sql = "SELECT * FROM jobpostings ORDER BY job_id DESC LIMIT $jobs_per_page OFFSET $offset";
...
$listing =get_job_list($page = 1, $jobs_per_page = 60);
...
if (count($words) > 50) {
    $limited_description .= '...';
        ...
        <div class="buttons">
          ...
          <a href="https://infra-rec.com/job-detail/?id='.$list['job_id'].'">  <button class="details">Details</button> </a>
        </div>
        </div>
